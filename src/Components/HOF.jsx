...
export default class HigherOrderFunction extends Component {
  ...
  //Render Data with Designers
  renderFilteredDataDesigner = () => {
  ...
  //Render Total Experience of Designers
  ...
  render() {
    return (
      <>
        ...
        {this.renderCompleteData()}

        <h1>Display based on user type</h1>
        {this.renderFilteredDataDesigner()}

        <h1>Filter all data starting with letter J</h1>
        {this.renderFilteredDataJ()}
